...
public class ViewDiscoveryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_seen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ViewDiscoveryActivity.this, DiscoveryViewerActivity.class);
    ...
    private void sendNotification(final String hisId, final String name, @SuppressWarnings("SameParameterValue") final String message){
    ...
    private void getStories(String userid){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                storiesProgressView.setStoriesListener(ViewDiscoveryActivity.this);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                username.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(ViewDiscoveryActivity.this, UserProfileActivity.class);
    ...
    private void addView(String storyid){
        FirebaseDatabase.getInstance().getReference("Discovery").child(userid)
